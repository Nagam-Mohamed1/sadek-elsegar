...
<head>
    ...
    <title> الكواكب في القرآن</title>
    <link rel="icon" href="tech/images/five.png">
...
<body>
  ...
  ?>
    <div class="container-fluid planets bot ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                <h1>
                    ورشة الكواكب في القرآن:
                </h1>
                ...
                <p>
                    من خلال الورشة سنذهب في رحلة سريعة إلى الفضاء وكيف تحدث عنه القرآن

                    <br><br>
                    من خلال الورشة سيتعرف الطفل على:


                </p>
                <ol>
                    <li> الآيات الخاصة بالكواكب</li>
                    <li>اسم الله الخالق</li>
                    <li>التفكر في الفضاء بشكل عام</li>
                    <li> الكواكب بشكل خاص</li>
                    <li> الأحجام المتفاوتة في الفضاء</li>
                    <li>أسرار خاصة بالهدهد الجميل</li>
                    <li>ترتيب كوكبنا</li>
                    <li>أكبر الكواكب وأصغرها</li>
                    <li>اسم مجرتنا</li>
                </ol>
                <p>
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-3" src="tech/images/five.png" alt="photo">
