...
<head>
    ...
    <title>و العاديات </title>
    <link rel="icon" href="tech/images/three.png">
...
<body>
  ...
  ?>
    <div class="container-fluid horse bot ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                ...
                <p>سنتحدث في هذة الورشة عن مخلوق عظيم وربطه بالآت القرآنية:
                </p>
                <ol>
                    <li> هل ذكر الخيل في القرآن</li>
                    <li> ما هي عائلة أفراد عائلته</li>
                    <li> مهارات حياتيه سنتعلمها من الخيل </li>
                    <li> تكوينه الداخلي هل له علاقة بعمله</li>
                    <li> كيفية استخدام الخيل في مكة المكرمة</li>
                    <li> أسرار تخص الخيل في الغزوات</li>
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-3" src="tech/images/three.png" alt="photo">
