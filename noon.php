...
<head>
    ...
    <title> النون </title>
    <link rel="icon" href="tech/images/four.png">
...
<body>
  ...
  ?>
    <div class="container-fluid noon bot ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                ...
                <p>
                    سنتحدث عن معجزة عظيمة ومدهشة تستحق الدراسة
                    أمر خارق للعادة بصورة واضحة جدا سنتدارس بعض الآيات
                    ونتعرف على:
                </p>
                <ol>
                    <li> من هو النونِ وذا النونِ</li>
                    <li> لماذا وقع الإختيار على هذا الحوت </li>
                    <li> ما اسمه وتصنيفه</li>
                    <li>معلومات مدهشة عنه وعن دورة حياته</li>
                    <li> أسرار خاصة بهذا المخلوق الضخم</li>
                    <li>تجارب حياتية وأنشطة جديدة</li>
                    <li>ما علاقة الحوت بالعلوم</li>
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-3" src="tech/images/four.png" alt="photo">
