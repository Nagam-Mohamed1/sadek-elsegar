...
<head>
    ...
    <title>العظام في القرآن</title>
    <link rel="icon" href="tech/images/twelve.png">
...
<body>
  ...
  ?>
    <div class="container-fluid bones bot  ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                <h1>
                    ورشة العظام في القرآن
                </h1>
                ...
                <p>ورشة نتحدث فيها عن العظام وربطها بالآيات القرآنية
                    ونتفكر في أنفسنا
                ...
                <ol>
                    <li> أهمية العظام</li>
                    <li> هل ذكرت في القرآن </li>
                    <li>ما علاقتها بالرياضيات</li>
                    <li>اللحم أولا أم العظم</li>
                    <li>لماذا الله خلق لنا العظام</li>
                    <li>نتعلم شكر الله الخالق المبدع</li>
                </ol>
                <p>
                ...
                <div class=" p">
                    ...
                    <ol>
                        <li>مرة إسبوعيا </li>
                        <li>3 لقاءات مباشرة</li>
                    </ol>
                </div>
            </div>

            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-5" src="tech/images/twelve.png" alt="photo">
