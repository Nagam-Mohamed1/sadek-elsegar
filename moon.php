...
<head>
    ...
    <title> و القمر إذا اتسق </title>
    <link rel="icon" href="tech/images/therteen.png">
...
<body>
  ...
  ?>
    <div class="container-fluid moon bot ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                <h1>
                    ورشة والقمر إذا اتسق
                </h1>
                <h3 class="mt-3">
                    (أطوار القمر)
                </h3>
                ...
                <p>
                    ورشة خاصة بالقمر وأطواره نستعرض هذا من خلال الآيات القرآنية
                    وسنتعلم:
                </p>
                <ol>
                    <li>ما هو القمر وأين يوجد</li>
                    <li> ما هي وظيفة القمر</li>
                    <li> هل يدور أم يظل ثابتا</li>
                    <li>هل هو مضئ أم معتم</li>
                    <li> إيه هي الأشهر الهجرية وعلاقتها بالقمر</li>
                ...
                <ol>
                    <li> أوراق العمل </li>
                    <li> التعلم النشط </li>
                    <li> التحديات المنزلية </li>
                    <li> الألعاب الإلكترونية</li>
                    <li>الفيديوهات المرئية</li>
                </ol>
                <div class=" p">
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-4" src="tech/images/therteen.png" alt="photo">
