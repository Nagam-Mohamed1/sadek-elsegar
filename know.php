...
<head>
    ...
    <title>عرفت ربي </title>
    <link rel="icon" href="tech/images/one.png">
...
<body>
  ...
  ?>
    <div class="container-fluid know bot">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                ...
                <p>
                    في هذه الورشة سنتحدث عن أساسيات هامة جدا لكل طفل مُسلم
                    مالا يسع الطفل المُسلم جهله عن دينه ونحاول:
                </p>
                <ol>
                    <li>نحكم على الأساسيات جدا</li>
                    <li>الفرق بين السنة الميلادية والهجرية</li>
                    <li>نصل إلى الأمور التي تصدق بالنفوس وتطمئن إليها القلوب</li>
                    <li>التكاليف العملية من عبادات</li>
                    <li>من هو الخالق أين هو</li>
                    <li>هل للخالق ولد أو أم</li>
                    <li>هل الخالق له صفات مميزة</li>
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-4" src="tech/images/one.png" alt="photo">
