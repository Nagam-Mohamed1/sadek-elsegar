...
<head>
    ...
    <title> عماد الدين </title>
    <link rel="icon" href="tech/images/fourteen.png">
...
<body>
  ...
  ?>
    <div class="container-fluid emad bot  ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                ...
                <p>
                    الصلاة هي عماد الدين أساس المسلم القوي الركن الثاني من أركان الإسلام بعد الشهادتين لذلك لها أهمية
                    عظيمة جدا
                    لذلك سنتعرف في هذه الورشة على:
                </p>
                <ol>
                    <li>تعريف الصلاة</li>
                    <li>متى فرضت الصلاة</li>
                    <li>كم عدد الصلاوات</li>
                    <li>أركان الصلاة</li>
                    <li>كيف نصلي</li>
                    <li>كيف نتطهر</li>
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-3" src="tech/images/fourteen.png" alt="photo">
