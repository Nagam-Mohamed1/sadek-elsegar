...
<head>
    ...
    <title> سبحان الذي أسرى</title>
    <link rel="icon" href="tech/images/eleven.png">
...
<body>
  ...
  ?>
    <div class="container-fluid esraa bot  ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                <h1>
                    برنامج سبحان الذي أسرى
                </h1>
                <h3 class="mt-3">
                    (الإسراء والمعراج)
                </h3>
                ...
                <p>
                    برنامج خاص لإصطحاب الطفل في رحلة من قبل 1444 عام رحلة أرضية وسماوية
                    من خلال آيات قرآنية سنتعرف على:
                </p>
                <ol>
                    <li>تاريخ الكعبة</li>
                    <li>تاريخ المسجد الأقصى</li>
                    <li>كيف أسرى النبي</li>
                    <li>معنى الإسراء والمعراج </li>
                    <li> مواصفات الدابة </li>
                    <li>ما هو المكان المرتفع الذي وصل له النبي</li>
                    <li>من هم الأنبياء الذين تحدث معهم نبينا محمد صلى الله عليه وسلم</li>
                ...
                <div class=" p">
                    ...
                    <ol>
                        <li>البرنامج مقدم من سن 5 سنوات حتى 9 سنوات</li>
                    </ol>
                    <h4>مدة البرنامج</h4>
                    <ol>
                        <li>مرة إسبوعيا </li>
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-4" src="tech/images/eleven.png" alt="photo">
