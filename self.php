...
<head>
    ...
    <title>وفي أنفسكم</title>
    <link rel="icon" href="tech/images/ten.png">
...
<body>
  ...
  ?>
    <div class="container-fluid self bot">
        <div class="row  ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                ...
                <p>و
                    <b> يتدبر في جزء صغير من نعم الله عزوجل - عليه، ويتعلم شكر النعمة، وعدم إلفها.</b>
                </p>

                <p style="font-size:20px;">
                    <b>
                        يهدف البرنامج إلى تعليم الأطفال التفكر والتدبر في النفس من خلال القرآن الكريم، وذلك من خلال:
                ...
                <div class="p">
                    ...
                    <ol>
                        <li>مرة إسبوعيا </li>
                        <li>6لقاءات مباشرة</li>
                    </ol>
                </div>
            </div>
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-3" src="tech/images/ten.png" alt="photo">
