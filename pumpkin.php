...
<head>
    ...
    <title> اليقطين </title>
    <link rel="icon" href="tech/images/six.png">
...
<body>
  ...
  ?>
    <div class="container-fluid pump bot">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">
                ...
                <p>
                    سنتعرف في هذه الورشة عن اليقطين وقصته في القرآن
                    سنتعلم عن:
                </p>
                <ol>
                    <li> ماهو اليقطين</li>
                    <li> هل اليقطين نوع واحد ولا أكثر</li>
                    <li> ما هي فوائده</li>
                    <li> كيف كانت غذاء ومأوى وشفاء </li>
                    <li> ما هي مميزات هذه الشجرة</li>
            ...
            <div class="left col-lg-3 col-12 m-lg-0 m-5">
                <img class="d-block m-auto w-lg-100 w-75 mb-3 mt-3" src="tech/images/six.png" alt="photo">
