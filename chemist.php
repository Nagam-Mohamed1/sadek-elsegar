...
<head>
    ...
    <title>الكيميائي الصغير</title>
    <link rel="icon" href="tech/images/sev.png">
...
<body>
  ...
  ?>
    <div class="container-fluid chemist bot ">
        <div class="row ">
            <div class="right col-lg-8 col-12 p-5 m-lg-3">

                <h1 style="text-align:right;">
                    برنامج الكيميائي الصغير
                </h1>
                ...
                <p>
                    ...
                    يهدف لتعليم الأطفال أساسيات الكيمياء من خلال القرآن

                </p>
                <h3 class="mt-2" style="text-align:right;">
                    سنتعرف على الآيات القرآنية الخاصة:
                </h3>
                <ol>
                    <li>المادة</li>
                    <li>أنواعها</li>
                    <li> ما هي تحولات المادة</li>
                    <li>ما هو بطل برنامجنا عنصر هام لا غنى عنه</li>
                </ol>
                <p>
                ...
                <ol>
                    <li> التجارب العمليه</li>
                    <li> الأنشطة اليدوية</li>
                    <li> الإختبارات التفاعليه</li>
                    <li> الأوسمة الإلكترونية </li>
                </ol>
                <div class=" p">
